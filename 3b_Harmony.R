...
########## Run PCA ##########
seuratObj <- RunPCA(object = seuratObj, features = VariableFeatures(seuratObj), npcs = 40, ndims.print = 1:5, nfeatures.print = 5)
...
seuratObj<-RunHarmony(seuratObj, group.by.vars = "orig.ident", theta = 2, plot_convergence = TRUE, nclust = 50,
                      max.iter.cluster = 150, max.iter.harmony = 20, dims.use=1:40)
